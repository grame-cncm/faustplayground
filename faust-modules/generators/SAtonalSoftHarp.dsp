...
//==================== GUI SPECIFICATION ================
N = 20;
hand = hslider("h:[1]/Instrument Hand[acc:0 1 -10 10 0 10]", 10, 0, N, 1) : automat(bps, 15, 0.0)// => gate
with{
...
t60 = hslider("h:[2]Reverberation/ Resonance[unit:s][acc:2 1 -10 10 0 5]", 5, 0.5, 10, 0.01):min(10):max(0.5);  // -60db decay time (sec)
