...
hand(0) = vslider("Instrument Hand[acc:1 0 -10 18 0 0]", 0, 0, 5, 1):int:automat(120, 15, 0.0);
hand(1) = vslider("Instrument Hand[acc:1 0 -10 18 0 0]", 0, 0, 5, 1):int:automat(120, 15, 0.0);
hand(2) = vslider("Instrument Hand[acc:1 0 -10 14 0 2]", 2, 0, 5, 1):int:automat(240, 15, 0.0);
hand(3) = vslider("Instrument Hand[acc:1 0 -10 14 0 2]", 2, 0, 5, 1):int:automat(240, 15, 0.0);
hand(4) = vslider("Instrument Hand[acc:1 0 -10 10 0 4]", 4, 0, 5, 1):int:automat(480, 15, 0.0);
hand(5) = vslider("Instrument Hand[acc:1 0 -10 10 0 4]", 4, 0, 5, 1):int:automat(480, 15, 0.0);
