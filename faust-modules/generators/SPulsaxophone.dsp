...
freq = hslider("h:Instrument/Frequency[unit:Hz][acc:1 1 -12 10 0 110]",110,80,880,1):smooth(0.9999):min(880):max(80);
gate = pulsaxo.gate;
...
vibratoFreq = hslider("h:Parameters/Vibrato Frequency[style:knob][unit:Hz][acc:0 1 -10 10 0 6]",6,1,15,0.1):smooth(0.999);
vibratoGain = 0.2;
vibratoBegin = 0.05;
vibratoAttack = 0.03;
vibratoRelease = 0.1;
