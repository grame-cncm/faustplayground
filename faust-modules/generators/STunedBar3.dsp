...
upfront(x) = x>x';
hand(0) = vslider("Instrument Hand 0 [acc:1 0 -10 14 0 0]", 0, 0, 5, 1):int:automat(120, 15, 0.0);
hand(1) = vslider("Instrument Hand 1 [acc:1 0 -10 14 0 2]", 2, 0, 5, 1):int:automat(240, 15, 0.0);
hand(2) = vslider("Instrument Hand 2 [acc:1 0 -10 10 0 4]", 4, 0, 5, 1):int:automat(480, 15, 0.0);
