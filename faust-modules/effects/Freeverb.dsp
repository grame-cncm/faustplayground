...
roomsizeSlider  = hslider("Reverberation Room Size[acc:1 1 -10 10 0 0.5]", 0.5, 0.1, 0.9, 0.025) : smooth(0.999) : min(0.9) :max(0.1) *scaleroom + offsetroom;
wetSlider       = hslider("Reverberation Intensity[acc:1 1 -10 10 0 0.3333]", 0.3333, 0.1, 0.9, 0.025) : smooth(0.999) : min(0.9) :max(0.1);
