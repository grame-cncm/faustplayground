...
gain = 1;
freq = hslider("[1]Grain Size[style:knob][acc:2 0 -10 10 0 200]",200,5,2205,1);
...
speed = hslider ("[2]Speed[unit:Hz][style:knob][acc:0 1 -10 10 0 10]",10,1,20,0.0001):lowpass(1,1); 
ratio_env = 0.5;
fade = (0.5); // min > 0 pour eviter division par 0
proba = hslider ("[3]Probability[unit:%][style:knob][acc:1 0 -10 10 0 70]",100,50,100,1) * (0.01):lowpass(1,1);
