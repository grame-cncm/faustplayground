...
phaser2Demo = phaser2_stereo_demo with {
   ...
   // FIXME: Add tooltips
   speed  = ctl_group(hslider("[1]Speed[acc:0 1 -10 10 0 3] [unit:Hz] [style:knob]", 0.5, 0, 10, 0.001));
   depth  = 1;
   fb     = 0.8;
...
drywet(x,y) 	= (1-c)*x + c*y
				with {
					c = hslider("[2]Phaser Intensity[style:knob][unit:%][acc:1 0 -10 10 0 10]",50,0,100,0.01)*(0.01):smooth(0.999);
					};
