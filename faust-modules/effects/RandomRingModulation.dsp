...
ringSpeed = hslider("[1]Ring Modulation Speed Range[scale:log][acc:2 0 -10 10 0 20]", 10, 10, 10000, 1) : smooth(0.99) : min(10000) : max(1);
...
speed = hslider ("[2]Occurrence Speed (Granulator)[unit:Hz][style:knob][acc:0 1 -10 10 0 4]",1,0.001,10,0.0001):lowpass(1,1);
proba = hslider ("[3]Probability(Granulator)[unit:%][style:knob][acc:0 1 -10 10 0 88]",88,75,100,1) *(0.01):lowpass(1,1);
