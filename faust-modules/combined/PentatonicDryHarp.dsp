...
process = vgroup("Harp", h : harpe(C,N,K) :>  instrReverbHarp : *(l),*(l))
	with {
		...
		h = hslider("[1]Instrument Hand[acc:0 0 -10 0 10]", 11, 0, N, 1) : int: automat(bps, 15, 0.0)
			with{
...
zita_rev1_stereo(rdel,f1,f2,t60dc,t60m,fsmax),_,_ <: _,!,_,!,!,_,!,_ : +,+
       ...
       roomSize = hslider("h:[3]Reverb/[2]Reverberation Room Size (InstrReverb)[style:knob][acc:1 0 -10 0 10]", 0.2,0.05,1.3,0.01):min(1.3):max(0.05);
       rdel = 20;
       f1 = 200;
       f2 = 6000;
       t60dc = roomSize*3;
