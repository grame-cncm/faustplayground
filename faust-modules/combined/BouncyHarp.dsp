...
N = 15;
hand = hslider("[1]Instrument Hand (Loop mode: hand>0 = recording, 0 = playback)[acc:1 1 -8 0 11]", 0, 0, N, 1);// => gate
gain = 1;
...
freq(d)	 = freq(d-5)*(2);
octave(d) = freq(d) * hslider("[2]Hight[acc:0 1 -10 0 10]", 3, 1, 6, 0.1) : smooth(0.999);	
...
zita_rev1_stereo(rdel,f1,f2,t60dc,t60m,fsmax),_,_ <: _,!,_,!,!,_,!,_ : +,+
       with{
       reverbGain = hslider("v:[8]Reverb/ Reverberation Volume (InstrReverb)[acc:1 0 -10 20 0 0.5] ",0.5,0.1,1,0.01) : smooth(0.999);
       roomSize = hslider("v:[8]Reverb/ÒReverberation Room Size (InstrReverb)[acc:1 0 -10 0 25]", 0.72,0.01,2,0.01);
       rdel = 20;
       f1 = 200;
       f2 = 6000;
       t60dc = roomSize*3;
