...
*/
"use strict";
var SceneAccueilView = (function () {
    function SceneAccueilView() {
    }
    SceneAccueilView.initWelcomeScene = function (scene) {
        ...
        startButton.onclick = function (event) { startButton.style.visibility = "hidden"; scene.parent.nextScene(); };
