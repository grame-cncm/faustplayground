...
var SceneExportView = (function () {
    ...
    SceneExportView.onloadExportScene = function (scene) {
    ...
    SceneExportView.initExportScene = function (scene, name) {
    ...
    SceneExportView.onunloadExportScene = function (scene) {
    ...
    ********************************************************************/
    ...
    SceneExportView.exportAndroidCallback = function (sha) {
