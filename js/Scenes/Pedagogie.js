...
var ScenePedagogieView = (function () {
    ...
    ScenePedagogieView.initPedagogieScene = function (scene) {
    ...
    ScenePedagogieView.onloadPedagogieScene = function (scene) {
        var nameInput = document.getElementById("nameTag");
    ...
    ScenePedagogieView.onunloadPedagogieScene = function (scene) {
        scene.muteScene();
    };
